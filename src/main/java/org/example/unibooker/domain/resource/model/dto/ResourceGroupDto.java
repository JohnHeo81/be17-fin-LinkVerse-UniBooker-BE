...
public class ResourceGroupDto {
    ...
    public static class ResourceGroupRegisterReq {
        ...
        @NotBlank(message = "서비스 그룹 이름은 필수입니다.")
        @Size(max = 100, message = "서비스 그룹 이름은 100자 이하여야 합니다.")
        @Schema(description = "서비스 그룹 이름", example = "회의실")
        private String name;

        @Size(max = 20, message = "서비스 그룹 코드는 20자 이하여야 합니다.")
        @Schema(description = "서비스 그룹 코드", example = "SRV001")
        private String groupCode;

        @Size(max = 500, message = "서비스 그룹 설명은 500자 이하여야 합니다.")
        ...
        @NotNull(message = "서비스 카테고리는 필수입니다.")
    ...
    public static class ResourceGroupUpdateReq {
        ...
        @Size(max = 100, message = "리소스 그룹 이름은 100자 이하여야 합니다.")
        @Schema(description = "리소스 그룹 이름", example = "동아리")
        private String name;

        @Size(max = 20, message = "리소스 그룹 코드는 20자 이하여야 합니다.")
        @Schema(description = "리소스 그룹 코드", example = "SRV001")
        private String groupCode;

        @Size(max = 500, message = "리소스 그룹 설명은 500자 이하여야 합니다.")
